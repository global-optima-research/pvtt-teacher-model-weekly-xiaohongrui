...
- [x] 在 pvtt 数据集上测试 First Frame Is the Place to Go for Video Content Customization 论文的效果
  ...
  * [FFGO 转场帧可视化](./week05-2026-03-16_to_2026-03-22/pvtt_ffgo_transition_frames.md)
  * [优化/创新方向分析](./week05-2026-03-16_to_2026-03-22/pvtt_optimization_research_cn.md) 
- [x] 训练数据集构建计划 [用于 Wan2.2 TI2V 5B + FFGO LoRA 微调的训练数据集](./week05-2026-03-16_to_2026-03-22/dataset_construction_plan.md)
