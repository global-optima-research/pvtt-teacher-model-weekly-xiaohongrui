#!/bin/bash
# =============================================================================
# 中性色填充 + Bbox Mask 商品替换实验
#
# 对应 Python: baseline/wan2.1-vace/exp_neutral_fill_bbox.py
#
# 所有参数均可通过环境变量覆盖：
#   FILL_VALUE=128 BBOX_MARGIN_LR=30 bash scripts/run_neutral_fill_bbox.sh
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/experiments/results/${MODEL_SIZE}/neutral_fill_bbox/${TIMESTAMP}}"
...
python3 "$BASELINE_DIR/exp_neutral_fill_bbox.py" \
