#!/bin/bash
# =============================================================================
# 中性色填充 + GrowMask + BlockifyMask 商品替换实验
#
# 对应 Python: baseline/wan2.1-vace/exp_neutral_fill_growmask.py
#
# 所有参数均可通过环境变量覆盖：
#   GROW_PIXELS=10 BLOCK_SIZE=32 bash scripts/run_neutral_fill_growmask.sh
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/experiments/results/${MODEL_SIZE}/neutral_fill_growmask/${TIMESTAMP}}"
...
# ---- 打印配置 ----
echo "============================================"
echo "中性色填充 + GrowMask + BlockifyMask 实验"
echo "============================================"
echo "模型:            $MODEL_SIZE"
echo "样本:            $SAMPLE_NAME"
...
python3 "$BASELINE_DIR/exp_neutral_fill_growmask.py" \
