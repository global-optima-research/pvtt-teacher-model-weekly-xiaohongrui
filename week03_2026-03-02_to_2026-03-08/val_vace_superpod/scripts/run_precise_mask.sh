...
# 精确 Mask + 参考图像商品替换实验
#
# 对应 Python: baseline/wan2.1-vace/exp_precise_mask.py
#
# 所有参数均可通过环境变量覆盖：
#   WAN_VACE_MODEL_SIZE=14B SEED=123 bash scripts/run_precise_mask.sh
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/experiments/results/${MODEL_SIZE}/precise_mask/${TIMESTAMP}}"
...
python3 "$BASELINE_DIR/exp_precise_mask.py" \
