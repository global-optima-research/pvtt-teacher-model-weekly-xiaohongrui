...
#
# 沿用 Canny 首帧粘贴工作流，但将 GrowMask 替换为 Bounding Box Mask。
...
#
#   # 跑全部 199 个任务
#   SAMPLED=0 bash scripts/run_pvtt_canny_paste_bbox.sh
#
#   # 自定义模型大小
#   WAN_VACE_MODEL_SIZE=14B bash scripts/run_pvtt_canny_paste_bbox.sh
# ===========================================================================
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_DIR/experiments/results/$MODEL_SIZE/pvtt_canny_paste_bbox/$TIMESTAMP}"
...
# ===========================================================================
echo "============================================================"
echo "PVTT 批量推理：Canny 首帧粘贴 + Bbox Mask"
echo "============================================================"
...
python3 "$PVTT_DIR/run_pvtt_canny_paste_bbox.py" \
