#!/bin/bash
# ===========================================================================
# PVTT 批量推理：Canny + Bbox Mask（原始输出，不合成）
#
# 与 run_pvtt_canny_paste_bbox.sh 的唯一区别：
#   输出视频是模型直接生成的原始视频，不经过 composite_with_mask 合成。
#   用于验证"割裂感"是否来自合成步骤。
#
# 用法：
#   bash scripts/run_pvtt_canny_paste_bbox_raw.sh
#
#   # 跑全部 199 个任务
#   SAMPLED=0 bash scripts/run_pvtt_canny_paste_bbox_raw.sh
# ===========================================================================
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_DIR/experiments/results/$MODEL_SIZE/pvtt_canny_paste_bbox_raw/$TIMESTAMP}"
...
# ===========================================================================
echo "============================================================"
echo "PVTT 批量推理：Canny + Bbox Mask（原始输出，不合成）"
echo "============================================================"
...
python3 "$PVTT_DIR/run_pvtt_canny_paste_bbox_raw.py" \
