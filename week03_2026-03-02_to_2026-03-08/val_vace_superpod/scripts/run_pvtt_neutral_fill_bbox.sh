...
#
# 输入 = mask video(中性色填充) + bounding box mask seq + ref img + prompt
# 输出 = composited target video + 四列对比图 + 首末帧展示
#
# 用法：
#   bash scripts/run_pvtt_neutral_fill_bbox.sh
#
#   # 仅处理采样的 23 个任务（每种产品 3 个）
#   SAMPLED=1 bash scripts/run_pvtt_neutral_fill_bbox.sh
#
#   # 自定义模型大小
#   WAN_VACE_MODEL_SIZE=14B bash scripts/run_pvtt_neutral_fill_bbox.sh
# ===========================================================================
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PROJECT_DIR/experiments/results/$MODEL_SIZE/pvtt_neutral_fill_bbox/$TIMESTAMP}"
...
# ===========================================================================
echo "============================================================"
echo "PVTT 批量推理：中性色填充 + Bbox Mask（实验 6）"
echo "============================================================"
...
python3 "$PVTT_DIR/run_pvtt_neutral_fill_bbox.py" \
