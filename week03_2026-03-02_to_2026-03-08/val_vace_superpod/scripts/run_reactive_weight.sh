#!/bin/bash
# =============================================================================
# Reactive 流权重调整实验（精确 Mask）
#
# 对应 Python: baseline/wan2.1-vace/exp_reactive_weight.py
#
# 所有参数均可通过环境变量覆盖：
#   WEIGHTS="0.0,0.3,0.5,0.7,1.0" bash scripts/run_reactive_weight.sh
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/experiments/results/${MODEL_SIZE}/reactive_weight/${TIMESTAMP}}"
...
python3 "$BASELINE_DIR/exp_reactive_weight.py" \
