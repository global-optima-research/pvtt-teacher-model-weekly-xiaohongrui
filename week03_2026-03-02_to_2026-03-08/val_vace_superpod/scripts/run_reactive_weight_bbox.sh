#!/bin/bash
# =============================================================================
# Reactive 流权重调整实验（Bbox Mask）
#
# 对应 Python: baseline/wan2.1-vace/exp_reactive_weight_bbox.py
#
# 所有参数均可通过环境变量覆盖：
#   WEIGHTS="0.0,0.3,0.5,0.7,1.0" BBOX_MARGIN_TOP=50 \
#       bash scripts/run_reactive_weight_bbox.sh
# =============================================================================
set -e
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/experiments/results/${MODEL_SIZE}/reactive_weight_bbox/${TIMESTAMP}}"
...
# ---- 打印配置 ----
echo "============================================"
echo "Reactive 流权重调整实验（Bbox Mask）"
echo "============================================"
echo "模型:        $MODEL_SIZE"
echo "样本:        $SAMPLE_NAME"
...
python3 "$BASELINE_DIR/exp_reactive_weight_bbox.py" \
