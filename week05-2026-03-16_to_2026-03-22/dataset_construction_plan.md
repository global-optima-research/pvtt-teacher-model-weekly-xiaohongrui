...
| `product_rgba.png` | 产品干净RGBA透明背景抠图 | RGBA PNG | 832×480 |
| `first_frame_raw.png` | 未处理过的原视频首帧图 | RGB PNG | 832×480 |
| `background.png` | 处理后的原视频首帧（做了object remove，可用作背景） | RGB PNG | 832×480 |
